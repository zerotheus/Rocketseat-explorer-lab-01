...
const securtiyCode = document.querySelector("#security-code")
const securtiyCodePattern = {
  mask: "0000",
}

const securtiyCodeMasked = IMask(securtiyCode, securtiyCodePattern)
...
securtiyCodeMasked.on("accept", () =>
  updateSecurityCode(securtiyCodeMasked.value)
)
